...
<div class="custom-modal position-fixed view-event" id="event"
    ...
    <div class="d-flex justify-content-center align-items-center " style="height: 100%;">
        <img id="show-event-modal" class="position-relative rounded" src="https://placehold.co/600x400/000000/FFF" alt="" style="z-index: 999999999;max-width: 500px ;width: 90%;">
    </div>
</div>
